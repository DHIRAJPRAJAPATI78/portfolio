          ...
          >
            ...
            >
              ...
              <span className='relative'>
                <span className='bg-gradient-to-r from-violet-500 to-orange-500 bg-clip-text text-transparent font-bold border-b-4  py-1'>
                  Dhiraj
                </span>
                <span
                 ref={spanRef}
...
I enjoy learning modern web technologies like React, Next.js, and MongoDB, and I'm eager to apply my skills to build clean, responsive, and impactful digital experiences.
            ...
            >
              ...
              backend and DevOps. Whether it's full-time or freelance, I'm open
              to exciting opportunities where I can grow and build dope stuff
              with amazing people.
            </p>
