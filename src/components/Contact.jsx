...
export default function Contact() {
  ...
  <div className="flex flex-col justify-center flex-1" style={{ opacity: 1 }}>
    <h3
    ...
    <p className="text-gray-300 mb-4" style={{ opacity: 1, transform: "none" }}>
      I'm available for full-time roles & freelance projects.
    </p>
    <p className="text-gray-300 mb-4" style={{ opacity: 1, transform: "none" }}>
      My inbox is always open, whether you have a question or just want to say hi.
    </p>
    <p className="text-gray-300 mb-8" style={{ opacity: 1, transform: "none" }}>
      I'll try my best to get back to you!
    </p>
    <div className="flex items-center gap-4" style={{ opacity: 1, transform: "none" }}>
      <a
        href="#"
